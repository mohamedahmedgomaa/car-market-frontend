...
const fetchAdmin = async () => {
  loading.value = true
  try {
    const res = await adminsApi.getById(route.params.id)
    admin.value = res.data.data
  } catch (err) {
    console.error(err)
    snackbarMessage.value = 'Failed to load admin data.'
...
const handleSubmit = async () => {
  ...
  try {
    await adminsApi.update(route.params.id, admin.value)

    snackbarMessage.value = 'Admin updated successfully!'
