...
const fetchSeller = async () => {
  loading.value = true
  try {
    const res = await brandSellerApi.getById(route.params.id)
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await brandSellerApi.update(route.params.id, formData)
    ...
    snackbarMessage.value = 'Failed to update brand. Please check your inputs.'
    snackbarColor.value = 'error'
    snackbar.value = true
  } finally {
    loading.value = false
