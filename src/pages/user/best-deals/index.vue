  ...
  <section class="best-deals-page py-12">
    <VContainer>
      <div class="d-flex align-center justify-space-between mb-8 flex-wrap gap-4">
        <div>
          <h1 class="text-h3 font-weight-black text-white mb-2">Best Deals</h1>
          <p class="text-h6 opacity-70 font-weight-medium">Price Crash & Best Market Deals</p>
        </div>
      ...
      <VCard class="pa-6" rounded="xl" elevation="0" style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05)">
        <div class="d-flex align-center justify-space-between mb-8">
          <div class="text-body-1 opacity-60">{{ total }} offers found</div>
        ...
        <div v-if="!loading && cars.length === 0" class="text-center py-16">
          ...
          <h3 class="text-h5 opacity-50">No deals found at the moment</h3>
        </div>
